	...
	The codes in this folder can be used to reproduce our work and make predictions for 
	new MHC-peptide pairs. 
	...
	main.py to 
	main(1)
	where the '1' stands for the first function.
	...
	(3)If you want to make binding predictions for your peptdies and MHC molecules,
	enter the sequences of the peptides and the alleles of the MHC molecules in the
	/binding_prediction/prediction_input.txt file. 
	The file /binding_prediction/prediction_input_example.txt contains some examples to
	show you the format of input data.

	(4)Newly trained models will be saved to the /models folder.

	(5)The output of all the other functions will be saved to the /results folder.
