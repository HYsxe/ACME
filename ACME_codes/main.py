...
def main(func_ind):
    ...
    main_dir = "/home/huyan/Attention_CNN/"
    ...
    if func_ind == 0:
        ...
        output_path = main_dir + "results/cross_validation.txt"
        ...
        output_path_1 = main_dir + "results/leave_one_out_3.txt"
        output_path_2 = main_dir + "results/leave_one_out_training.txt"
